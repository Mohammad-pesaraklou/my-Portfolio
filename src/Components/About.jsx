...
const About = () => {
    return (
        ...
        <Grid container className='container'p={2}>
           ...
           <Grid item xs={12} sx={{display:"flex",justifyContent:{xs:"left",md:"center"},ml:{xs:15,sm:0,lg:0},alignItems:"center"}}>
           ...
           <Grid container spacing={1} sx={{display:{xs:"block",md:"flex"},justifyContent:"center",alignItems:"center"}}>
                ...
                <Typography  fontFamily='Quicksand' color={"#db6300"} sx={{ml:{xs:15,sm:0,lg:0}}} variant='h4' mb={5} >
                    Who i am
                </Typography>
                <Typography variant="h6" sx={{textTransform: "capitalize",fontSize:"20px",mt:{xs:9,md:0}}} fontFamily='Quicksand' textAlign="left">
                ...
                <Typography  sx={{fontSize:"20px",mt:4}} fontFamily='Quicksand' textAlign="left">
